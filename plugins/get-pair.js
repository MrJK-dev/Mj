...
const { zandile } = require("../settings");
...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://lightdeskteam-session.onrender.com/pair?phone=${q}`);
...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://lightdeskteam-session.onrender.com/pair?number=${q}`);
        const pair = await response.json();
